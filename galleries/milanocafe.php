    ...
    <section class="breadcrumbs">
        <div class="container">
            ...
            <div class="d-flex justify-content-between align-items-center">
                <h2>Milano Cafè - Networking Event</h2>
                <ol>
                    <li><a href="../index.php">Home</a></li>
                    <li>Milano Cafè - Networking Event</li>
                </ol>
            </div>
    ...
    <section class="portfolio">
        <div class="container">
            <div class="wrapper">
                <div class="masonry">
                    <?php
                    $images = scandir("../assets/img/events/milanocafe2021/", 1);
                    foreach ($images as $result) {
                        echo "<div class='brick'><img src='../assets/img/events/milanocafe2021/".$result."' ></div>";
                    }
                    ?>
                </div>
            </div>
