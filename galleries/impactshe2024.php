...
<main id="main">
    ...
    <section class="breadcrumbs">
        <div class="container">
            ...
            <div class="d-flex justify-content-between align-items-center">
                <h2>ICPN - ImpactShe 2024</h2>
                <ol>
                    <li><a href="../index.php">Home</a></li>
                    <li>ICPN - ImpactShe 2024</li>
                </ol>
            </div>
    ...
    <section class="portfolio">
        <div class="container">
                <div class="masonry">
                    <?php
                    $images = scandir("../assets/img/events/impactshe2024/photos/", 1);
                    foreach ($images as $result) {
                        echo "<div class='brick'><img src='../assets/img/events/impactshe2024/photos/".$result."' ></div>";
                    }
                    ?>
                </div>
            </div>
