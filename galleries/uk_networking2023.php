...
<main id="main">
    ...
    <section class="breadcrumbs">
        <div class="container">
            ...
            <div class="d-flex justify-content-between align-items-center">
                <h2>ICPN - London Networking Event 2023</h2>
                <ol>
                    <li><a href="../index.php">Home</a></li>
                    <li>ICPN - London Networking Event 2023</li>
                </ol>
            </div>
    ...
    <section class="portfolio">
        <div class="container">
                <div class="masonry">
                    <?php
                    $images = scandir("../assets/img/events/uk_networking2023/photos", 1);
                    foreach ($images as $result) {
                        echo "<div class='brick'><img src='../assets/img/events/uk_networking2023/photos/".$result."' ></div>";
                    }
                    ?>
                </div>
            </div>
